...
from code.Constante import WIN_WIDTH, COLOR_YELLOW, COLOR_RED
...
class Menu:
    ...
    def menu_text(self, text_size: int, text: str, text_color: tuple, text_center_pos: tuple, border_color=(0, 0, 0),
                  border_size=3):
